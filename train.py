...
upsample_filter_np_2x = bilinear_upsample_weights(upsamples_stride_2, number_of_classes)
upsample_filter_tensor_2x = tf.Variable(upsample_filter_np_2x, name='vgg_16/fc8/t_conv_2x')
upsampled_logits = tf.nn.conv2d_transpose(logits, upsample_filter_tensor_2x,
...
# upsamples_stride_2
upsample_filter_np_2x_2 = bilinear_upsample_weights(upsamples_stride_2, number_of_classes)
upsample_filter_tensor_2x_2 = tf.Variable(upsample_filter_np_2x_2, name='vgg_16/fc8/t_conv_2x_2')
upsampled_logits = tf.nn.conv2d_transpose(upsampled_logits, upsample_filter_tensor_2x_2,
...
# Additional predictions from pool3, at stride 8
upsample_factor_8x = 8
upsample_filter_np_8x = bilinear_upsample_weights(upsample_factor_8x, number_of_classes)

upsample_filter_tensor_8x = tf.Variable(upsample_filter_np_8x, name='vgg_16/fc8/t_conv_8x')
upsampled_logits = tf.nn.conv2d_transpose(upsampled_logits, upsample_filter_tensor_8x,
                                          output_shape=upsampled_logits_shape,
                                          strides=[1, upsample_factor_8x, upsample_factor_8x, 1],
                                          padding='SAME')
########################
